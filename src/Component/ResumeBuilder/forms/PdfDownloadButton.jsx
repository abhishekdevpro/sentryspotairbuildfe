...
const PdfDownloadButton = ({ targetRef }) => {
  ...
  return (
    <button 
      ...
      className="inline-flex items-center justify-center px-5 py-2.5 text-sm font-medium text-white bg-black rounded-lg focus:ring-2 focus:outline-none focus:ring-gray-200"
    >
      Download
    </button>
  );
