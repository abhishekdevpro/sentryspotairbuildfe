          ...
          {experiences.map((exp, index) => (
            <div key={index} className='ms-10'>
              ...
              <div>
                ...
                <h6 className='text-sm'>{exp.role || "Software Developer"}</h6>
                <ul className='m-2 text-xs'>
                <li dangerouslySetInnerHTML={{ __html: exp.companydescription || "Description of job experience" }} />
                  {/* <li>{DOMPurify.sanitize(exp.companydescription || predefinedText.experiences.companydescription)}</li> */}
                </ul>
              </div>
            </div>
          ))}
